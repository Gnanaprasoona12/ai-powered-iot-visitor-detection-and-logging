...
# ✅ SEND OTP TO ESP32 KEYPAD
def send_otp_to_esp32(otp):
    try:
        requests.get(f"{ESP32_IP}:8080/set_otp", params={"otp": otp}, timeout=2)
    except:
        print("Failed to send OTP to ESP32")
...
while True:
    ...
    if current_time - last_detection_time > COOLDOWN:
        ...
        if is_resident:
            ...
            print(f"OTP sent to ESP32 keypad: {otp}")

            # ⏳ WAIT (ESP32 handles verification)
            time.sleep(10)
